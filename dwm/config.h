...
static const char col_cyan[]        = "#073763";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F3,     spawn,          SHCMD("volume-control up") },
	{ MODKEY,                       XK_F2,     spawn,          SHCMD("volume-control down") },
	{ MODKEY|ShiftMask,             XK_F1,     spawn,          SHCMD("setxkbmap us") },
	{ MODKEY|ShiftMask,             XK_F2,     spawn,          SHCMD("setxkbmap gr") },
	{ MODKEY,                       XK_space,  spawn,          SHCMD("rofi -modi drun,run -show drun -show-icons") },
	{ MODKEY,                       XK_s,      spawn,          SHCMD("flameshot gui") },
	{ MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("$HOME/scripts/set-work-screens") },
	{ MODKEY|ShiftMask,             XK_b,      spawn,          SHCMD("background-change") },
	{ MODKEY,                       XK_t,      spawn,          SHCMD("teams") },
	{ MODKEY,                       XK_c,      spawn,          SHCMD("skype") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
